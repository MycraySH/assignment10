...
rasasp = raster("D:/LifeInUCSB/Study/GEOG176A/week3/assignment10/data/mount-sh-aspect.tif")
plot(rasasp, box = FALSE,axes = FALSE, col = rainbow(8),main = "aspect")

stac = stack(raselev,rashill,rasslope, rasasp) %>% 
  setNames(c( "elevation","hillshade","slope", "aspect"))
plot(stac, box = FALSE,axes = FALSE)
```
